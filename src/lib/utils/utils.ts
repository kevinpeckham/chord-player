// written by Håken Lid
	...
	export function polarToCartesian(x:number, y:number, r:number, degrees:number) {
	...
	// written by Håken Lid
export function segmentPath(x:number, y:number, r0:number, r1:number, d0:number, d1:number): string {
